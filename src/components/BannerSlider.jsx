  ...
  return (
    <div className="h-screen">
      <Carousel className="">
        ...
        />
          <div className="absolute inset-0 flex h-full w-full bg-[#1a0d2196]">
            <div className="lg:w-10/12 w-11/12 mx-auto lg:mt-20 mt-3">
              <Typography
                variant="h1"
                color="white"
              ...
              >
                Review games, manage your watchlist, and elevate your gaming experience—all in one place! 🎮
              </Typography>
